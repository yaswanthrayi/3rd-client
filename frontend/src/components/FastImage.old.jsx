...
import { optimizeImage, getThumbnail, getUltraFastThumbnail, createBlurPlaceholder, getFullQualityImage } from '../utils/imageOptimizer';

/**
 * FastImage Component - Ultra-fast blur-to-sharp progressive loading
 * Features: Instant blur placeholder, progressive loading, aggressive caching, lazy loading, error handling
 */
const FastImage = ({
  src,
  alt = '',
