    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <Loader className="w-8 h-8 animate-spin text-fuchsia-600" />
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 pt-20 pb-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <button
            onClick={handleBack}
            className="inline-flex items-center gap-2 mb-6 px-3 py-2 text-gray-600 hover:text-fuchsia-600 transition-colors duration-200"
          >
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-fuchsia-100 rounded-full mb-4">
              <UserIcon className="w-8 h-8 text-fuchsia-600" />
            </div>
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                {!isEditing ? (
                  <button
                    onClick={handleEdit}
                    className="inline-flex items-center gap-2 px-4 py-2 bg-fuchsia-600 hover:bg-fuchsia-700 text-white font-medium rounded-lg transition-colors duration-200"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white font-medium rounded-lg transition-colors duration-200"
                  >
                    <X className="w-4 h-4" />
                    Cancel
                  </button>
...
/>
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-200">
                    <button
                      type="submit"
                      disabled={saving}
                      className="w-full sm:w-auto px-8 py-3 bg-fuchsia-600 hover:bg-fuchsia-700 disabled:bg-fuchsia-400 text-white font-semibold rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
                    >
                      {saving ? (
                        <>
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="w-full px-4 py-3 border border-gray-200 rounded-lg bg-gray-50 text-gray-900 min-h-[100px] whitespace-pre-wrap">
